 ...
 */
RenderEngine.prototype.getAxisGroup = function () {
 ...
 */
RenderEngine.prototype.getBarsGroup = function () {
 ...
 */
RenderEngine.prototype.getOverlayGroup = function () {
 ...
 */
RenderEngine.prototype.setHeight = function (height) {
	if (!this._svg) {
		return;
	}
...
RenderEngine.prototype.destroy = function () {
	...
	var parent = this._svg.parentNode;
	if (parent) {
		parent.textContent = '';
	}
