/**
 * @fileoverview
 * Парсит длительность (elapsed/duration) из различных форматов:
 * - Число: 150.5 → 150.5
 ...
 * @private
 */
function parseStringWithUnit(str) {
 ...
 *
 * @example
 * parseElapsed('1,200 ms');
 * // → 1200.0
 *
 * @example
 * parseElapsed('00:00:00.050');
 * // → 50.0
 *
 * @example
 * parseElapsed(null);
...
export function parseElapsed(value) {
	...
	return parseStringWithUnit(trimmed);
}
